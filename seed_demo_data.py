...
def seed_data():
    ...
    defects = [
        ("TMS", "RAIL-101", "CORR-NDLS-CNB", "Rail Fracture Risk", 5, "2026-09-02", "2026-09-07", 3.5, "Engineering"),
        ("SMMS", "SIG-204", "CORR-NDLS-CNB", "Point Machine Failure", 4, "2026-09-03", "2026-09-08", 2.0, "S&T"),
        ("TDMS", "TRK-305", "CORR-HWH-MGS", "Track De-stressing", 3, "2026-09-04", "2026-09-10", 4.0, "Track Machine"),
        ("TMS", "RAIL-108", "CORR-BCT-BRC", "Worn Out Switch Rail", 4, "2026-09-05", "2026-09-09", 3.0, "Engineering"),
        ("COA", "OHE-401", "CORR-MAS-GDR", "Cantilever Alignment Defect", 2, "2026-09-06", "2026-09-11", 1.5, "Engineering"),
        ("SMMS", "SIG-210", "CORR-HWH-MGS", "Axle Counter Maintenance", 3, "2026-09-05", "2026-09-09", 2.5, "S&T"),
        ("TDMS", "TRK-312", "CORR-NDLS-CNB", "CSM Tamping Operation", 4, "2026-09-04", "2026-09-08", 4.5, "Track Machine"),
        ("TMS", "RAIL-115", "CORR-SBC-MYS", "Fishplate Joint Defect", 2, "2026-09-06", "2026-09-12", 2.0, "Engineering"),
        ("SMMS", "SIG-218", "CORR-BCT-BRC", "Track Circuit Glitch", 5, "2026-09-06", "2026-09-07", 1.5, "S&T"),
        ("COA", "BLK-502", "CORR-MAS-GDR", "Level Crossing Gate Interlocking", 3, "2026-09-05", "2026-09-10", 3.0, "S&T"),
        ("TDMS", "TRK-320", "CORR-BCT-BRC", "BCM Ballast Cleaning", 5, "2026-09-03", "2026-09-08", 5.0, "Track Machine"),
        ("TMS", "RAIL-122", "CORR-HWH-MGS", "Deep Screening Required", 4, "2026-09-04", "2026-09-11", 4.0, "Engineering"),
        ("COA", "OHE-415", "CORR-NDLS-CNB", "Catenary Wire Tension Check", 1, "2026-09-07", "2026-09-13", 1.5, "Engineering"),
        ("SMMS", "SIG-225", "CORR-SBC-MYS", "Signal LED Lamp Replacement", 1, "2026-09-07", "2026-09-13", 1.0, "S&T"),
        ("TDMS", "TRK-333", "CORR-MAS-GDR", "Unimat Switch Tamping", 2, "2026-09-06", "2026-09-12", 3.0, "Track Machine"),
        ("TMS", "RAIL-130", "CORR-NDLS-CNB", "Track Alignment Deviation", 3, "2026-09-05", "2026-09-10", 2.5, "Engineering"),
        ("SMMS", "SIG-231", "CORR-HWH-MGS", "Block Instrument Defect", 4, "2026-09-06", "2026-09-08", 2.0, "S&T"),
        ("TDMS", "TRK-345", "CORR-SBC-MYS", "DGS Track Stabilization", 3, "2026-09-05", "2026-09-11", 3.5, "Track Machine"),
    ]
